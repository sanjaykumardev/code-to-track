    ...
    <>
      ...
      <div className='w-full flex justify-center bg-gray-900 items-center  h-[110vh]'>
        <div className='flex flex-coljustify-center items-center space-y-2 w-[100%] md:w-[30%] '>
          <div className=' w-full bg-white from-white to-gray-100 rounded-2xl p-8 border-5 border-white shadow-lg m-8'>
            <div className="heading text-center font-extrabold text-5xl text-blue-500">REGISTER</div>
